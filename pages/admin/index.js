...
// تُجهّز المصدر للعرض: تضيف basePath لو موجود (لكن لا تغيّر الروابط الخارجية)
...
/* ===================== رافع ملفات مشترك ===================== */
function Uploader({ onUploaded, api, basePath }) {
...
function SettingsTab({ api, basePath }) {
  ...
  async function load() {
    ...
    setForm({
      ...
      // نخزن كما في DB (جذري)، والعرض لاحقًا يضيف basePath
